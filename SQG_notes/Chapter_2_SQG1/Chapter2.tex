...
\end{align*}
This match with Eq \ref{F^1 and Phi^0 relation}. Similarly we can set 
\[ G^1_{int} = \frac{f}{\Bur N^2} \Phi_x^0\Phi_z^0\]
Then similar as $\Phi^1$. The total Fourier mode is the sum of interior part and surface part. Where surface part is set to match the boundary condition. THe equations are 
...
For the Vertical Velocity : 
{
    ...
    \begin{align*}
        ...
        \indetext{\text{The Fourier Transform aren't function of $x$ or $y$}} 
